...
class QueryTransport implements Transport\TransportInterface
{
     ...
     */
    public function __construct(TransmissionInterface $transmission, \devmx\Teamspeak3\Query\Transport\CommandTranslatorInterface $translator, ResponseHandlerInterface $responseHandler)
    {
